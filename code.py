...
data_copy = data.copy()
illicit = pd.read_csv('drug-use-health/illicit.csv', index_col=0,low_memory=False)
...
data_neu = data[['CIG30TPE','CIGDLYMO','CIG100LF','PIPE30DY','ALCUS30D','IRALCFY','IRMJFY','IRCIGFM','IRCGRFM','IRSMKLSS30N','IRALCFM','IRALCBNG30D','IRMJFM','IRCIGAGE','IRCDUAGE','IRCGRAGE','IRSMKLSSTRY','IRALCAGE','IRMJAGE','CIGFLAG','CGRFLAG','PIPFLAG','SMKLSSFLAG','TOBFLAG','ALCFLAG','MRJFLAG','DCIGMON','ALCYDAYS','MRJYDAYS','CIGMDAYS','CGRMDAYS','SMKLSMDAYS','ALCMDAYS','MRJMDAYS','CIGAVGD','FUCIG18','FUCIG21','FUCGR18','FUCGR21','FUSMKLSS18','FUSMKLSS21','FUALC18','FUALC21','FUMJ18','FUMJ21','BLNTEVER','BLNTAGE','BLNT30DY','BLNTNOMJ','DEPNDALC','DEPNDMRJ','ABUSEALC','ABUSEMRJ','ABODALC','ABODMRJ','CDUFLAG','CDCGMO','BNGDRKMON','HVYDRKMON','BNGDRMDAYS','FUCD218','FUCD221','DNICNSP','UDPYIEM']]
#print(data_neu.head(5))
data_neu = pd.concat([data_neu,illicit],axis=1)
